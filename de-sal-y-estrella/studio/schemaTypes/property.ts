...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      group: 'content',
      description: 'Dirección completa, e.g., Avenida Las Higueras 671...',
    }),
    defineField({
      name: 'wifiName',
      title: 'Nombre de red WiFi',
      type: 'string',
      group: 'content',
    }),
    defineField({
    ...
    defineField({
      name: 'tower',
      title: 'Torre o Edificio',
      type: 'string',
      group: 'content',
      description: 'Solo si aplica, e.g., 2',
    }),
    defineField({
      name: 'parkingInfo',
      ...
      type: 'string',
      group: 'content',
      description: 'Número de estacionamiento, e.g., 401',
    }),
    defineField({
      name: 'tagline',
